...
header('Content-Length: ' . filesize($aFilePath));
?>
<!doctype html>
...
<head>
   <title>Plychannel Video Player</title>
   ...
   .flowplayer .fp-logo {       display: block; opacity: 0.2;   }
   </style>
   ...
   <script type="text/javascript">
      ...
      flowplayer(function (api, root) {
         api.bind("load", function () {
            ...
            video.duration = (typeof video.duration == "undefined" || video.duration =="Infinity")? 0 : video.duration; 
