...
?>
		...
		<div class="bottomBar">
			...
			<div class="navBar">
				...
				<a href="http://plychannel.com/channelAbout?u=<?php echo $channelUser; ?>"><div style="border-bottom: #ff0000 3px solid; opacity: 1;">About</div></a>
			</div>
		</div>
		
		<div class="content">
			<p><?php echo $channel['About']; ?></p>
		</div>
