<?php
  ...
  $query = mysql_query("SELECT * FROM `videos` WHERE `Category` = 'Movies' AND `Uploaded` = '1' AND `Privacy` = 'a' AND `Time` > '".(time() - 2678400)."' ORDER BY `Views` DESC ,`Time` DESC LIMIT 15");
?>
...
<h3 style="font-size: 18px;font-weight: bold;color: #000;">
  <a href="http://plychannel.com/Movies">Movies</a>
</h3>
